...
The [included demo](https://github.com/gangwang2020/yuv-canvas/docs/demo.html) combines Y, U, and V planes from grayscale JPEGs into a color photograph on a canvas. Check it out!
